...
{
    public class TimeGroup_2Controller : Controller
    {
        ...
        public async Task<ActionResult> TimeList_2()
        {
            Users UserActual = await DAOCommand.InforUserActual(true);
            List<TimeList> ListData = await DAOCommand.SelListaTiempos_2(UserActual);
